...
step
    #completewith next
    +Welcome to the |cFFfa9602Pandaren Starting Zone|r Guide by RestedXP.
...
step
    ...
    >>Go inside the |cFFfa9602building|r and defeat |cRXP_ENEMY_Sparring Trainees.|r
...
step
    ...
    .goto 378,57.89,36.55,15 >> Enter the |cFFfa9602cave.|r
	.timer 87,Cave RP
step
    #sticky
...
step
	...
	.cast 106299 >>Use the |T519378:0|t[Wind Stone] |cFFfa9602at the Shrine.|r
    .use 72109
step
...
step
	.isOnQuest 29420
    .goto 378,41.09,24.83,10 >> Enter the |cFFfa9602cave.|r
step
...
step
    ...
    .goto 378,51.58,40.46,20 >> Travel |cFFfa9602to the Temple of Five Dawns.|r
step
...
step
    ...
    .home >>Set Hearthstone to |cFFfa9602the Temple of Five Dawns.|r
...
step
    .isOnQuest 29661
	#label Shrine
    .goto 378,61.39,47.87,5 >>Navigate towards the |cFFfa9602Shrine|r by hopping onto the poles that are nearest to it.
step
...
step
    ...
    >>Use the |T463854:0|t[Sun Pearl] on the |cFFfa9602Water's Surface.|r
...
step
    ...
    >>Follow |cRXP_FRIENDLY_Shu|r closely as he moves around. He'll cast a Spout |cFFfa9602in the nearby water.|r Make sure to position yourself |cFFfa9602on top of it.|r
...
step
	.isOnQuest 29770
    .goto 378,77.05,71.02,10 >> Enter |cFFfa9602the cave|r
step
	#label Carrots
...
step
	.isOnQuest 29770
    .goto 378,74.99,69.42,10 >> Leave |cFFfa9602the cave|r
step
...
step
    ...
    .goto 378,30.42,37.50,20 >>Travel to |cFFfa9602Morning Breeze Village|r
step
...
step
    ...
    .goto 378,26.42,33.68,30 >> Travel to the |cFFfa9602Jade Pillar.|r
step
	#completewith next
...
step
    ...
    .goto 378,28.94,62.89,20 >>Travel |cFFfa9602to the Temple.|r
	.isOnQuest 29785
step
	#sticky
	#label Temple2
...
step
    ...
    .goto 378,22.70,52.80,40 >>Travel |cFFfa9602to The Elders' Path.|r
step
...
step
    ...
    .goto 378,52.28,68.43,30 >>Travel |cFFfa9602to the Pei-Wu Gate|r
...
step
    #completewith next
    .hs >> Hearthstone |cFFfa9602to the Temple of Five Dawns.|r
step
...
step << Horde
    #completewith next
    .goto 85,49.87,75.52,20 >> Go |cFFfa9602inside Grommash Hold.|r
step << Horde
    .goto 85,48.76,70.77
