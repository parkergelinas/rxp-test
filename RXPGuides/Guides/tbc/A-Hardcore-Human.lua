...
step << Warlock
    #completewith LockVW
    .goto Elwynn Forest,71.0,80.8,150 >> Travel to the Brackwell Pumpkin Patch. Grind en-route
step << Warlock
    .isOnQuest 147
...
step
    #completewith troggs
    .subzone 134 >> Travel to Gol'Bolar Quarry
step
...
step << !Warlock
    ...
    >>|cRXP_WARN_Save any|r |T133970:0|t[|cRXP_LOOT_Chunks of Boar Meat|r]|r |cRXP_WARN_to use for leveling |T133971:0|t[Cooking] |cRXP_WARN_later|r
...
step << !Warlock
    #completewith next
    .subzone 924 >> Travel to the Valley of Kings
    .xp >12,1 -- shows to 11 and under
step << !Warlock
